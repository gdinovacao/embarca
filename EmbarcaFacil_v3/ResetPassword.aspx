<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResetPassword.aspx.vb" Inherits="EmbarcaFacil_v3.ResetPasswordE" %>
                ...
                <div class="span12">
                    <div class="login-container">
                        <div class="row-fluid">
                            <div class="center">
                                <h1>
                                    <%--<i class="icon-leaf green"></i>--%>                                    <%--<span class="red">Ace</span>--%>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <h4 class="header blue lighter bigger">
                                                <%--<i class="icon-coffee green"></i>--%>Reset - Informe a nova senha
                                            </h4>
                                                ...
                                                <div>
                                                    ...
                                                    <label>
                                                        <span class="block input-icon input-icon-right">
                                                            <asp:TextBox ID="txtNovaSenhaReset" class="span12" required="" placeholder="Nova senha" runat="server" TextMode="Password"></asp:TextBox>
                                                    ...
                                                    <label>
                                                        <span class="block input-icon input-icon-right">
                                                             <asp:TextBox ID="TxtNovaSenhaConfirmeReset"  class="span12" required="" placeholder="Confirme a nova senha" runat="server" TextMode="Password"></asp:TextBox>
                                       ...
                                       <div style="text-align:center;" class="toolbar clearfix">
                                            <div style="text-align:center; width:100% ">
                                                <a style="text-align:center;" href="Login.aspx" class="forgot-password-link">
