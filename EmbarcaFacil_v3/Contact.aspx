        ...
        <div class="container">
            ...
            <div class="row contact">
                <p>
                    ...
                    <div class="row form">
                        <div class="span6 box">
                            <input id="nome"  class="name" type="text" required="" placeholder="Name"/>
                            <input id="email" class="mail" type="text" required="" placeholder="Email"/>
                            <input id="phone" class="phone" type="text" required="" placeholder="Phone"/>
                        </div>
                        <div class="span6 box box_r">
                            <textarea id="desc" placeholder="Escreva sua mensagem..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row submit">
                        ...
                        <div class="span3 right">
                            <asp:Button ID="cmdEnviar" runat="server" Text="Enviar mensagem" />
